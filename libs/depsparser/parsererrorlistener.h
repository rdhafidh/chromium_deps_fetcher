...
class ParserErrorListener : public ANTLRErrorListener {
 public:
  ...
  virtual void reportAttemptingFullContext(Parser *, const dfa::DFA &, size_t,
                                           size_t, const antlrcpp::BitSet &,
                                           atn::ATNConfigSet *);

  virtual void reportContextSensitivity(Parser *, const dfa::DFA &, size_t,
                                        size_t, size_t, atn::ATNConfigSet *);
};
